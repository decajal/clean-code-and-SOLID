(() => {
  ...
  // En User y en UserProps NO hay que hacer nada debido al BAJO ACOPLAMIENTO
  interface UserProps {
    email: string;
    role: string;
  }
  ...
  // En Settings y en SettingsProps NO hay que hacer nada debido al BAJO ACOPLAMIENTO
  ...
  // Acá si hay ACOPLAMIENTO, pero los cambios son un poco más sencillos.
  // Nuevo User Settings
